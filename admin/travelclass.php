      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            ...
            <a class="active item" href="travelclass.php">Clases de viajes</a>
          </div>
        </div>
        ...
        <div class="column" id="content" style="display:none">
	        <div class="ui grid">
            <div class="row">
              <h1 class="ui huge header">Todas las clases de viajes</h1>
            </div>
            <div class="ui horizontal divider"> Clases de viaje disponibles</div>      
              ...
              <table class="ui single line striped selectable center aligned  table">
                <thead>
                  <tr>
                    <th>ID</th>
                    <th>Clase de viaje</th>
                    <th>Capacidad de clase</th>
                    <th>Precio</th>
