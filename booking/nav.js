...
function confirmdetails(){	
    ...
    //
    $("#details").html("<ul><li> PROPIETARIO DEL TICKET: "+fullname+"</li><li>RUTA: "+destination+"</li><li>FECHA DEL VIAJE: "+traveldate+"</li><li>CLASE DE VIAJE: "+travelclass+"</li><li>NUMERO DE ASIENTOS: "+seats+"</li><li>CANTIDAD PAGO: "+amount+" Via "+paymethod+" ID Transaccion: "+code+"</li></ul>");	
...
function senddata(){
    ...
    paymethod=$("#paymentmethod").val();
    //Clearing all data 
    $("#dynamic").html("<div class='ui text container'><div id='err001' class='ui success icon message'><i class='notched circle loading icon'></i><div class='content'><div class='header'>Espere por favor....</div><p>Lo estamos haciendo todo por ti</p></div></div>");    
